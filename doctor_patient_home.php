...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="row match-height">
    <?php
    $query = "SELECT * FROM `appointment` WHERE `doctor_email` = '$email'";
    ...
    <div class="col-md-6 col-lg-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="doctor_patient_app.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary">View Appointment</a>
        </div>
      </div>
    </div>
    <?php
