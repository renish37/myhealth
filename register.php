...
// {
// $insert = "INSERT INTO `users` (`username`, `email`, `pwd`,`edate`) 
...
<head>
    ...
    <title>Register - My Health </title>
          ...
          <div class="auth-wrapper auth-cover">
            <div class="auth-inner row m-0">
              <!-- Brand logo--><a class="brand-logo" href="index.php">
                ...
                <h2 class="brand-text text-primary ms-1">My Health</h2></a>
              <!-- /Brand logo-->
              <!-- Left Text-->
              <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="app-assets\images\form image\register-v2.svg" alt="Register V2"/></div>
              </div>
              <!-- /Left Text-->
              <!-- Register-->
              <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                  ...
                  <p class="card-text mb-2">Store your Health record easy!</p>
                  <form class="auth-register-form mt-2" action="register.php" name="frmregister" id="frmregister" method="POST">
                    <div class="mb-1">
                      <label class="form-label" for="register-username">Username</label>
                      <input class="form-control" name="username" id="register-username" type="text" name="register-username" placeholder="johndoe" aria-describedby="register-username" autofocus="" tabindex="1"/>
                      <span id="uname_response"></span>
                    </div>
                    <div class="mb-1">
                      <label class="form-label" for="register-email">Email</label>
                      <input class="form-control" name="email" id="register-email" type="email" name="register-email" placeholder="john@example.com" aria-describedby="register-email" tabindex="2"/>
                    </div>
                    <div class="mb-1">
                    ...
                    <button class="btn btn-primary w-100" tabindex="5" id="btnsignup">Sign up</button>
      ...
      if(username != ''){
         ...
         $.ajax({
            ...
            success: function(response){
              ...
              else{  alert("insideelse");  $('#uname_response').html(response.msg); return false;}
