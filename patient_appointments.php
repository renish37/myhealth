...
if(isset($_POST['fullname'])){
  ...
  $query = "INSERT INTO `appointment` (`id`, `name`, `gender`, `phone`, `address`, `city`, `email`, `description`, `doctor_email`, `status`, `date`) VALUES (NULL, '$fullname', '$gender', '$phone', '$address', '$city', '$email', '$description', '$d_email', 'pending', current_timestamp());";
        ...
        <div class="card-body">
          <div class="user-avatar-section">
            <div class="d-flex align-items-center flex-column">
              ...
              <div class="user-info text-center">
                ...
                <?php $doctor_email =  $row['email'] ?>
                <span class="badge bg-light-secondary"><?php echo $row['role'] ?></span>
              </div>
            </div>
          </div>
          <div class="d-flex justify-content-around my-2 pt-75">
            ...
            <div class="d-flex align-items-start">
              ...
              <div class="ms-75">
                <?php
                  $query1 = "SELECT * FROM `appointment` WHERE `email` = '$email' AND `doctor_email` = '$doctor_email' AND `status` = 'pending'";
                  $result1 = mysqli_query($con,$query1);
                  $num = mysqli_num_rows($result1);
                ?>
                <h4 class="mb-0"><?php echo $num; ?></h4>
